...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 0","margin":"0 0 10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>报名时间：</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
		  :style='{"border":"1px solid #5FE3EB","padding":"3px 10px","outline":"none","borderRadius":"8px","background":"#fff","width":"auto","justifyContent":"center"}'
          start-placeholder="报名时间起始"
          end-placeholder="报名时间结束"
		  ...
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    ...
		    <div :style='{"padding":"0 10px","overflow":"hidden","flex":"1","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"110px","padding":"0 10px 0 0","flex":"1"}'>
				...
				<div class="title">{{item.baomingshijian}}</div>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.timeRange.length > 0) {
          searchWhere.baomingshijianstart = this.timeRange[0];
          searchWhere.baomingshijianend = this.timeRange[1];
        }
		if(!this.centerType){
			params['sfsh'] = '是';
		}
