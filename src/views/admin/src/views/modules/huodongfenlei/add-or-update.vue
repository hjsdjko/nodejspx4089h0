<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="活动分类" prop="huodongfenlei">
					<el-input v-model="ruleForm.huodongfenlei" placeholder="活动分类" clearable  :readonly="ro.huodongfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="活动分类" prop="huodongfenlei">
